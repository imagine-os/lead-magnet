...
Part IV: which channel fits which prospect, the four-sentence message, the fourteen-day behaviour-driven cadence, sending honestly while the transport is a placeholder, and reading the funnel without lying to yourself.
...
3. Choosing the channel (`{{channels}}`)
4. What to say
5. The cadence
6. Sending, honestly
7. Reading the funnel (`{{kpi:funnel}}`, `{{kpi:outreach}}`)
8. Open decision
9. Three things that lose the deal
10. Prev / next footer
