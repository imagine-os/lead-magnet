...
export const PLAN: T[] = [
  ...
  ['T31', 'Screenshots at 7 widths, light/dark', 'qa', '', 'Sonnet 5', 3, ['T20'], 'doing', 'T20 captured 15 key codes at 390 / 1280 (dark for HUB-01, L-01, C-01); the 7-width sweep for every code remains'],
  ['T32', 'Responsive + a11y QA matrix', 'qa', '', 'Sonnet 5', 3, ['T20'], 'doing', 'T20 ran the 7-width responsive matrix on every built route (docs/qa/responsive-report.md); the axe / keyboard a11y matrix remains'],
