...
Part II of the ops manual: creating a prospect, running the adaptive intake, what the weighted question loop asks first, the 30 % confidence gate and what each confidence band is publishable as, and confirming or rejecting the guessed tool stack before composing anything.
...
1. Chapter head - code, part, title, summary, role / version / updated
2. Switcher + prev / next + print
3. Create the prospect
4. The adaptive intake (+ the confidence gate)
5. Confirming the stack
6. What you are aiming for before you compose (`{{kpi:intake}}`)
7. Open decision
8. Prev / next footer
