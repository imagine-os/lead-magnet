...
- `docs/changelog/0023-integration-pass-3.md` (pass 3 integration: `DataTable` sortable headers on slot / prospect / duration / contact / requested / status; upcoming defaults to soonest first, past to latest first)
