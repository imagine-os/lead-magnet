...
Part III: choosing an archetype from the live ranking, previewing the real public route rather than a second renderer, the 14-day expiry rule, frozen slugs, snapshots versus recomposition, and running A/B variants honestly.
...
3. The four archetypes (`{{archetypes}}`, then the shape of each)
4. Preview the real page
5. Publish, and the 14-day rule
6. Snapshots, not live recomposition
7. Variants (+ open decision)
8. Before you send the link (checklist)
9. Prev / next footer
