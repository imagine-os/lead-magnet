...
| --- | --- | --- | --- |
| 0 | Foundation: scaffold, tokens, shell, data seam, components, engine, hub + dev tools + canvas, stubs, docs | Fable 5.1 | done (this turn) |
| 1 | Modules in parallel (six workers on one branch, module contract in `CLAUDE.md`) | Opus 5 | backlog |
| 2 | Integration: build green, code review, decisions, surfaces, push | Fable 5.1 | backlog |
| 3 | Polish passes: Spanish fill, screenshots, responsive + a11y matrix, ops manual | Sonnet 5 / Opus 5 | backlog |
...
| `plan` | K-01..K-04 | Kanban, list, timeline with dependency edges, task detail | Opus 5 | T10 |
| `studio` | S-01..S-05 | prospects, profile + AI intake, composer, assets, outreach composer | Opus 5 | T11 |
| `landing` | L-01..L-05 | Reveal / Audit / Walkthrough / Letter archetypes, sections, tracking, expired | Opus 5 | T12 |
| `os-demo` | C-01..C-07 | tailored OS demo with role views, departments, comms, money, life, settings | Opus 5 | T13 |
| `booking` | B-01, B-02 | book a call, confirmed | Opus 5 | T14 |
| `admin` | A-01..A-05 | funnel, prospect timeline, events, outreach board, bookings | Opus 5 | T15 |
| `proposal` + `website` | R-01, W-01..W-03 | client proposal view; our website home, how it works, pricing + purchase | Opus 5 | T16 |
| `manual` | M-01..M-05 | ops manual chapters EN/ES | Opus 5 | T33 |
...
| T10 | Plan viewer: Kanban, list, timeline with dependency edges | plan | K-01..K-04 | Opus 5 | 1 | T06, T07 | backlog |
| T11 | Studio: prospects, AI intake, composer, assets, outreach composer | studio | S-01..S-05 | Opus 5 | 1 | T05, T06 | backlog |
| T12 | Landing archetypes Reveal/Audit/Walkthrough/Letter + sections + tracking | landing | L-01..L-05 | Opus 5 | 1 | T05, T06 | backlog |
| T13 | Tailored OS demo with role views | os-demo | C-01..C-07 | Opus 5 | 1 | T05, T06 | backlog |
| T14 | Booking flow | booking | B-01 B-02 | Opus 5 | 1 | T06 | backlog |
| T15 | Analytics, events, outreach board, bookings admin | admin | A-01..A-05 | Opus 5 | 1 | T06 | backlog |
| T16 | Client proposal view + our website and pricing flow | proposal/website | R-01 W-01..W-03 | Opus 5 | 1 | T05, T06 | backlog |
| T20 | Integration, build green, code review, decisions, push | integration | - | Fable 5.1 | 2 | T10..T16 | backlog |
