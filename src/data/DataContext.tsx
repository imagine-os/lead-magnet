...
import { bindTracking } from '../tracking';

const Ctx = createContext<DataProvider | null>(null);
/** Swap the provider here when Supabase is ready (T44). */
...
export function useData(): DataProvider { const v = useContext(Ctx); if (!v) throw new Error('useData outside DataProviderRoot'); return v; }
