...
export const strings = {
  ...
  'demo.save_done': { en: 'Workspace saved', es: 'Espacio guardado' }, 'demo.save_done_body': { en: 'We kept this exact setup. The link works for 14 days.', es: 'Guardamos esta configuración. El enlace funciona 14 días.' },
