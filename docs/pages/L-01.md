...
- `useScrollFrames(12)` maps the hero's scroll progress to a frame index; today it drives a CSS transform and the role shown inside each device, and it is the seam a generated frame sequence plugs into (T41).
